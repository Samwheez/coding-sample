...
This code snippet showcases a simple, creative solution to that problem.  It uses server side events to update the status view with a loading bar and the current active processing step.  
